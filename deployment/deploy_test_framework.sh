...
helm upgrade --install jmeter-loadtest-config-chart $3/helm/jmeter_loadtest_config_chart -f $3/helm/jmeter_loadtest_config_chart/values.yaml -n $namespace --wait